<x-app-layout>
    ...
    <x-header>
        ...
        <h2 class="text-2xl font-medium">Tambah user sistem</h2>
    ...
    <form method="POST" action="{{ route('users.store') }}" class="p-5 border border-zinc-300 rounded-xl">
        @csrf
