<x-app-layout>
    ...
    <x-header>
        <h2 class="text-2xl font-medium">Tambah siswa</h2>
    ...
    <form action="{{ route('siswa.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="w-full space-y-4">
            ...
            <label class="block space-y-1">
                ...
                <x-text-input name="nisn" placeholder="Masukkan NISN siswa (10 digit)" class="w-full"></x-text-input>
            ...
            <label class="block space-y-1">
                ...
                <x-text-input name="nama_lengkap" placeholder="Masukkan nama lengkap siswa"
