<x-app-layout>
    ...
    <div class="flex justify-between items-center gap-5 pb-4 border-b border-zinc-300">
        ...
        <h2 class="text-2xl font-medium">Tambah tahun ajar</h2>
    ...
    <form action="{{ route('tahun_ajar.store') }}" method="POST" enctype="multipart/form-data"
        class="space-y-4 w-full self-center p-5 rounded-2xl border border-zinc-300">
        @csrf

        <div class="w-full space-y-4">
            <label class="block space-y-1">
                <x-input-label>Kode tahun ajar*</x-input-label>
                <x-text-input type="number" min="1" name="kode_tahun_ajar"
                    placeholder="Masukkan kode tahun ajar" class="w-full"></x-text-input>
            ...
            <label class="block space-y-1">
                ...
                <x-text-input name="nama_tahun_ajar" placeholder="Masukkan nama tahun ajar"
        ...
        <div class="flex items-center justify-start gap-2 md:pt-2">
            <x-primary-button>Tambah tahun ajar</x-primary-button>
        </div>
    </form>
