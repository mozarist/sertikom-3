    ...
    <form action="{{ route('tahun_ajar.update', $tahun_ajar->id) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="w-full space-y-4">
            <label class="block space-y-1">
                ...
                <x-text-input type="number" min="1" name="kode_tahun_ajar" value="{{ $tahun_ajar->kode_tahun_ajar }}"
                    placeholder="Masukkan kode tahun ajar" class="w-full" />
        ...
        <div class="flex items-center justify-start gap-2 md:pt-2">
            <x-primary-button>Edit tahun ajar</x-primary-button>
        </div>
    </form>
